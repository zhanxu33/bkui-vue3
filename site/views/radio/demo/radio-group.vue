<template>
  ...
  >
    <bk-radio label="QQ" :before-change="() => handleBeforeChange('QQ')"/>
    <bk-radio label="微信" :before-change="() => handleBeforeChange('微信')"/>
    <bk-radio label="Email" :before-change="() => handleBeforeChange('Email')"/>
  </bk-radio-group>
